...
<body>
  <div class="container">
    ...
    <div class="row blockTexteLog">
        ...
        <div class="col-lg-12">
          <form method ="post" action="ModifEtu.php">
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-lg-6">
                <label for="inputName"></label>
                <input type="texte" class="form-control" id="Stage" name="Stage" placeholder="Stage">
              </div>
              <div class="form-group col-lg-6">
                <label for="inputName"></label>
                <input type="texte" class="form-control" id="Associatif" name="Associatif" placeholder="Associatif">
              </div>
              <div class="form-row">
                <div class="form-group col-lg-4">
                  <label for="inputPassword4"></label>
                  <input type="texte" class="form-control" id="Majeur" name="Majeur" placeholder="Majeur">
                </div>
                <div class="form-group col-lg-4">
                  <label for="inputPassword4"></label>
                  <input type="texte" class="form-control" id="ING" name="ING" placeholder="ING">
                </div>
                <div class="form-group col-lg-4">
                  <label for="inputPassword4"></label>
