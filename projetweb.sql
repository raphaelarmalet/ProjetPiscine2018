...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 04 mai 2018 à 22:18
...
CREATE TABLE IF NOT EXISTS `etudiant` (
  ...
  KEY `IDUser` (`IDUser`)
) ENGINE=InnoDB AUTO_INCREMENT=151884 DEFAULT CHARSET=utf8;
...
(151883, 'clouetvalentin@gmail.com', 3, 'SI', 'SQL,Compta', 'Aucune');
...
('clouetvalentin@gmail.com', 'Clouet', 'Valentin', 'azertyu', 'Homme', 'Etudiant', 'e', 'FR,CH,ENG', 'ECE', '0143568276', 20, 1),
